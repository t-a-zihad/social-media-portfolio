	  ...
	  <!--content-area is starting from here -->
		<section class="main-content row">
				...
				<div class="content col-lg-5">
					...
					<?php
						$selecting_all_post= mysqli_query($conn, "SELECT * FROM post_info WHERE post_user_name='$logged_in_user_total_name' ORDER BY post_id DESC");
					...
					<div class="posted-news-feed">
						...
						<div class="posted-user-info after">
							...
							<div class="mr-info float-right">
								...
								<div class="hidden-menu dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuButton">
									<a href="editPost.php?edit=<?php echo $has_posted_id;?>" class="dropdown-item">Edit Post</a>
									<a href="../inc/dpost.php?del=<?php echo $has_posted_id;?>" class="dropdown-item">Delete Post</a>
								</div>
